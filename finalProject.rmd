...
# for html with svg
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, dev = 'svglite')
```
...
```{r echo=FALSE}
plot(continuous_movies$my_rating, fit_gam4$fitted.values,xlim=c(0,100),ylim=c(0,100),xlab="My Rating",ylab="Fitted Values",main="My Rating vs Fitted Values",col="aquamarine3")
legend(x = "topleft", title="Models", bg="transparent",
       legend=c("GAM with BIC Variables"), 
       fill = c("aquamarine3"))
abline(0,1)
```
